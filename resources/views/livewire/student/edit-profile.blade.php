    ...
    <div class="container max-w-2xl mx-auto mt-8">
        ...
        @if(!$isEditing)
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div class="font-semibold text-right">User Name (Japanese):</div>
                <div>{{ $nameJapanese }}</div>
        ...
        @else
            <form wire:submit.prevent="confirmUpdate">
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="text-right">
                        <label for="nameJapanese" class="block my-2">User Name (Japanese)</label>
                    </div>
                    <div>
                        <input type="text" id="nameJapanese" wire:model.lazy="nameJapanese" class="w-full px-3 py-2 border rounded">
                        @error('nameJapanese') <span class="text-red-500">{{ $message }}</span> @enderror
                    </div>
                    <div class="text-right">

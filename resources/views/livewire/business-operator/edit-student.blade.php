<div class="container mx-auto px-4 py-8" x-data="{ showDeleteConfirmation: @entangle('showDeleteConfirmation') }">
        ...
        <div class="flex flex-col md:flex-row">
            <div class="md:w-1/3 mb-4 md:mb-0 relative">
                ...
                @if ($isEditing)
                    ...
                    <input type="file" wire:model="tempImage" id="tempImage"
            ...
            <div class="md:w-2/3 md:pl-6">
                ...
                @else
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="nameJapanese">
                                Name (Japanese)
                            </label>
                            <input wire:model="nameJapanese"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="nameJapanese" type="text">
                            @error('nameJapanese')
                                <span class="text-red-500 text-xs italic">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input wire:model="contactPhoneNumber"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
    ...
    <div class="mt-8 text-center">
        <a href="{{ route('business-operator.students.index') }}"

<div class="bg-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <p class="text-xl font-semibold text-black my-6">My Job Listings: <span
                class="text-red-600">{{ count($jobListings) }}</span></p>
        ...
        <nav class="flex flex-col justify-center gap-4 mt-12 sm:flex-row">
            <a href="{{ route('job-seeker.view', ['id' => $candidateId]) }}"

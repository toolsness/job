...
<head>
    ...
    <title>Company Representative Account Approved</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h1>Company Representative Account Approved</h1>
        <h2>Dear {{ $user->name }},</h2>

        <p>Your company representative account has been approved. You can now log in to the system using your email and
            password.</p>

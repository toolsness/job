...
<p>The scouted candidate has selected a time and date for the interview:</p>
...
<ul>
    ...
    <li>Date: {{ $interview->implementation_date->format('F j, Y') }}</li>
    <li>Time: {{ $interview->implementation_start_time->format('g:i A') }}</li>
</ul>

<p>Please check the interview details on the Interview List page.</p>

...
<head>
    ...
    <title>Company Admin Account Registration</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h1>Company Admin Account Created Successfully</h1>
        <h2>Hello {{ $name }}!</h2>
        <p>Your Company Admin account for {{ $companyName }} has been created successfully.</p>

        <p>You can log in to the system using the following credentials:</p>
        <ul>
            <li>Email: {{ $email }}</li>
